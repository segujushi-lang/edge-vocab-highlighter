...
选中 `serendipity`，点击“保存并高亮”。此后它再次出现在网页中时，会被你选择的荧光笔颜色标出；点一下，高亮旁边就会显示中文“意外发现”。不再需要这个词时，可以在释义卡或词库中直接移除。
...
| 自定义颜色 | 在扩展弹窗中选择任意荧光笔颜色，已打开的网页会即时同步 |
...
单击高亮即可打开释义卡。释义卡显示英文原词和中文翻译，并提供“移出词库”按钮。移除后，当前页面上的对应高亮会立即消失，之后的网页也不再标注。
...
点击 Edge 工具栏中的“拾词”，在顶部“荧光笔颜色”区域打开颜色选择器。选中的颜色会保存在本机，并立即应用到所有已打开网页中的高亮；之后访问的网页也会继续使用该颜色。点击“默认”可恢复初始黄色 `#FFDD57`。
